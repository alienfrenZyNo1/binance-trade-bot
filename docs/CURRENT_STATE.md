...
| Futures | USDC-M perpetuals, 1x leverage, CROSS margin | ✅ Active |
...
| P1 | Backtest needs revalidation (train/OOS inversion, no slippage) | #92 |
| P2 | 42+ unmerged Snyk security branches | #93 |
| P2 | Circuit breaker thresholds could be tighter (5→3% daily) | #88 |
