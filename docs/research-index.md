...
| `scripts/research_regime_v2_evaluator.py` | Research-only Regime v2 scorecard/evaluator using strategy-utility labels, walk-forward legacy/v1/v2 comparison, and optional weight tuning | `python3 scripts/research_regime_v2_evaluator.py --days 30 --coins SOL,SUI,AAVE,LINK,AVAX,JUP --step-hours 6 --forward-hours 24 --tune-scorecard --output /tmp/regime_v2.json` |
